...
const services = [
  ...
  { icon: Map, title: "Street Registration", description: "Register or renew street names in Ifo LGA.", color: "text-primary", bg: "bg-primary/10", link: "/dashboard/street-registration" },
    ...
    <section id="services" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">Ifo LGA Government Services</h2>
